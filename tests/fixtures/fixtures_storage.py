...
def html_for_storage():
    ...
    <div class="entry">
        <div class="show-episode-page"><h1>title one</h1></div>
        <div class="large-content-text"><p>desc one</p></div>
        <div class="episode-buttons"><a href="/mp3/podcast_0.mp3"></a></div>
    </div>
    </body>
    </html>'''
